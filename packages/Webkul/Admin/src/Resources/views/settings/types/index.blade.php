<x-admin::layouts>
    <x-slot:title>
                ...
                <div class="flex items-center gap-x-2.5">
                    ...
                    <div class="flex items-center gap-x-2.5">
                        @if (bouncer()->hasPermission('settings.lead.types.create'))
                            <button type="button" class="primary-button" @click="$refs.typeSettings.openModal()">
        ...
        @pushOnce('scripts')
            <script type="text/x-template" id="types-settings-template">
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        :placeholder="trans('admin::app.settings.types.index.create.color')"
                                    />
