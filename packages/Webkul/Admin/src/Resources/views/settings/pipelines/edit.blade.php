<x-admin::layouts>
    ...
    <x-slot:title>
        ...
        <x-admin::form :action="route('admin.settings.pipelines.update', $pipeline->id)" method="POST">
            <!-- Header section -->
            <div
                class="flex flex-col gap-2 rounded-lg border border-gray-200 bg-white text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                <div class="flex items-center justify-between px-4 py-2">
                    <div class="flex flex-col gap-2">
                        {!! view_render_event('admin.settings.pipelines.edit.breadcrumbs.before', ['pipeline' => $pipeline]) !!}

                        <!-- Breadcrumbs -->
                        <x-admin::breadcrumbs name="settings.pipelines.edit" :entity="$pipeline" />
                ...
                <div
                    class="flex gap-4 border-t border-gray-200 px-4 py-2 align-top dark:border-gray-800 max-sm:flex-wrap">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control type="text" name="name" id="name" rules="required"
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control type="text" name="rotten_days" id="rotten_days"
                    ...
                    <x-admin::form.control-group class="mt-4 flex items-center gap-4">
                        ...
                        <x-admin::form.control-group.control type="switch" class="cursor-pointer" name="is_default"
                            id="is_default" value="1" :checked="(boolean) $pipeline->is_default"
