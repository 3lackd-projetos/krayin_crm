    ...
    'configuration' => [
        'index' => [
            ...
            'magic-ai' => [
                ...
                'settings' => [
                    'api-key' => 'Chave API',
                    'api-key-info' => 'Use uma chave API do OpenRouter ou Google Gemini para cada modelo. É um passo simples para melhorar a segurança e o desempenho.',
                    'enable' => 'Habilitar',
                    'info' => 'Melhore sua experiência com o Magic AI com sua chave API do OpenRouter ou Google Gemini. Integre-a agora para uma aventura de IA personalizada e perfeita, feita sob medida para você! Personalize as configurações com facilidade e assuma o controle da sua jornada de IA.',
                    'other' => 'Outro Modelo',
                    'other-model' => 'Para outros modelos, use o ID do Modelo do OpenRouter ou Google.',
